...
#ifndef ALTERA_AVALON_RASTER_REGS_H_
#define ALTERA_AVALON_RASTER_REGS_H_
...
#define sample_memory_read(offset)          IORD_32DIRECT  (VGA_RASTER_VGA_RASTER_INTERNAL_INST_AVS_TRI_ARGS_BASE, offset)
#define sample_memory_write(offset, data)   IOWR_32DIRECT  (VGA_RASTER_VGA_RASTER_INTERNAL_INST_AVS_TRI_ARGS_BASE, offset, data)

#define buffer_memory_read(offset)          IORD_8DIRECT  (ONCHIP_MEMORY_BASE, offset)
#define buffer_memory_write(offset, data)   IOWR_8DIRECT  (ONCHIP_MEMORY_BASE, offset, data)
...
#endif /* ALTERA_AVALON_RASTER_REGS_H_ */
